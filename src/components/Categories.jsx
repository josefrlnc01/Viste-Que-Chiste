...
export default  function Categories(){
   ...
   return(
    ...
    <button onClick={() => handleSuccesCategorie('Generales')} className="categorie-btn min-w-1/2 bg-blue-500 p-6 rounded-xl flex justify-between text-white items-center "><span className="font-bold bg-blue-950 text-white p-1 rounded-b-md">450</span> <span>GENERALES</span>  </button>
