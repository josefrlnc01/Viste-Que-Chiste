...
export default  function Categories(){
   ...
   return(
    ...
    <button onClick={() => handleSuccesCategorie('Generales')} className="categorie-btn min-w-1/2 bg-blue-500 p-6 rounded-xl">GENERALES </button>
    ...
    <button onClick={() => handleSuccesCategorie('Fútbol')} className="categorie-btn  min-w-1/2 bg-pink-500 p-3 rounded-xl">FÚTBOL</button>
       
        <button onClick={() => handleSuccesCategorie('Jaimito')} className="categorie-btn min-w-1/2 bg-pink-500 p-3 rounded-xl">JAIMITO </button>
